    ...
    execute: function () {
      ...
      _export("GameCenterController", GameCenterController = (_dec = ccclass('GameCenterController'), _dec(_class = class GameCenterController extends Component {
        ...
        initGameClient(callBack) {
          let parameters = new Node((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          this.gameClient.initAsync().then(async () => {
            ...
            let gameClientParams = parameters.addComponent(_crd && StoreAPI === void 0 ? (_reportPossibleCrUseOfStoreAPI({
              error: Error()
            }), StoreAPI) : StoreAPI);
...
//# sourceMappingURL=53ee97ba298ffce958f8e315733eba8aae41d34d.js.map