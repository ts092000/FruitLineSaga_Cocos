    ...
    execute: function () {
      ...
      _export("ItemLeaderboard", ItemLeaderboard = (_dec = ccclass('ItemLeaderboard'), _dec2 = property({
        ...
        init(name, score, order, isDirect) {
          ...
          if (!isDirect) {
            var color = new Color();
            var stringHex = this.listColor[order];
            Color.fromHEX(color, stringHex);
            var colorCup = new Color();
            var stringCup = this.listColorCup[order];
...
//# sourceMappingURL=66c3aa981c1e6f064187b4cb1c988b166e738e8b.js.map