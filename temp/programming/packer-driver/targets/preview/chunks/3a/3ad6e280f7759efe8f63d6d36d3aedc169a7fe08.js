  ...
  return {
    ...
    execute: function () {
      ...
      _export("ScoreManager", ScoreManager = (_dec = ccclass('ScoreManager'), _dec2 = property({
        ...
        setLabelScore() {
          var convert = this.score.toString();

          while (convert.length < 4) convert = "0" + convert;

          for (var i = 0; i < convert.length; i++) this.listLabelScore[i].string = convert[i];
        }
...
//# sourceMappingURL=3ad6e280f7759efe8f63d6d36d3aedc169a7fe08.js.map